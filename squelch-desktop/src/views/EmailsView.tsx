// EMAILS VIEW — the classic band list (formerly the whole "sitrep" chassis).
//
// Header (signal/noise + last checked) · STANDING / SINCE LAST CHECK / STILL
// OPEN bands · collapsed noise line · a compact "auth messages" pill. This is
// the band-list-of-email-rows surface: everything it used to do as the main
// view is unchanged — it just lives behind the "Emails" sidebar tab now, with
// the Sitrep dashboard promoted to the default surface.
//
// Keyboard-first: j/k traverse bands; Enter drills into a thread; r/e/d/t
// dispatch through lib/dispatch (the seam to ActionLayer). Owns the "list"
// KeyContext — all its historical bindings keep working exactly here.
...
export function EmailsView() {
  ...
  // Auth/rules/audit are routed VIEWS now (sidebar), not side panels. Their
  // historical keybinds (g / T / A) route to the matching view instead of
  // opening a panel; browse/search stay as side panels within Emails.
